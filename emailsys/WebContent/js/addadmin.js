...
var builderUQTQueryMsg = function (UQTQueryMsg){
    ...
    //修改表头信息
    //--------------------------------------------------
    var th = '<caption>所有待审批注册信息：</caption><tr class="listheader"><th>账户ID</th><th>姓名</th><th>性别</th><th>操作</th></tr>';
    ...
    $.each(UQTQueryMsg, function(i,eachData){
       ...
       /* this.userID = userID;
        ...
        //修改每行数据
        //--------------------------------------------------
        var strUrl1 = "admin/updateAdmin.action?userID=" + userID;
        ...
        UQT_detailTable.append('<tr><td>'+userID+'</td>'
							+'<td>'+userName+'</td>'
						    +'<td>'+userGender+'</td>'
						    +'<td><a class="clickbutton" href= '+ strUrl1 +'>通过</a></td></tr>');
